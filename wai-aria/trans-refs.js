...
CSS: 'http://momdo.github.io/css2/cover.html',
DOM: [ 'http://www.y-adagio.com/public/standards/tr_dom2_core/expanded-toc.html',
	'http://www2u.biglobe.ne.jp/~oz-07ams/2003/Core/index.html',
],
HTML: 'http://www.asahi-net.or.jp/~sd5a-ucd/rec-html401j/cover.html',
...
RDF: 'http://www.asahi-net.or.jp/~ax2s-kmtn/internet/rdf/rdf-concepts.html',
RDFS: 'http://www.asahi-net.or.jp/~ax2s-kmtn/internet/rdf/REC-rdf-schema-20140225.html',
	...
	(function(){
		...
		for(id in refList){	// リストを巡回
			if(refList.hasOwnProperty(id)){	// "おまじない"
				if(dd = document.getElementById("ref_" + id)){	// 当該 ID を持つ要素があることを最初に確認
